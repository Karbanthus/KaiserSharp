...
namespace OriannaTheruleroftheBall
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color=\"#66CCFF\" >Kaiser's Orianna -The ruler of the Ball</font><font color=\"#CCFFFF\" >{0}</font> - " +
        ...
        static Obj_AI_Hero GetEQ(Obj_AI_Hero target, Vector3 Ball)
        {
            Obj_AI_Hero NewETarget = null;
        ...
        static void ELineCheckHit()
        {
            ...
            foreach (Obj_AI_Hero hero in ObjectManager.Get<Obj_AI_Hero>().Where(x => x.IsEnemy && x.IsValidTarget()))
            {
        ...
        static void Spellbook_OnCastSpell(Spellbook sender, SpellbookCastSpellEventArgs args)
        {
            ...
            var count = Utility.CountEnemiesInRange(BallManager.Ball.Position, R.Width - 15);
